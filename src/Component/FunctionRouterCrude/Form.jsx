    ...
    <>
        <div className='container mt-5'>
            <div className='text-center pb-4'>
                <Link to={"/table"} className='btn btn-danger'>Table</Link>
            </div>
            <form action="" className="shadow-lg p-3 rounded-3" id="form">
                ...
                <input type="text" name="lname" value={obj.lname} className="input_group w-100 mb-2" onChange={handleChange}/>

                <input type="file" name="profile" onChange={handleChange}/> <br />
